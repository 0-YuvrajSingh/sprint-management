...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(
        ...
        return build(HttpStatus.NOT_FOUND, ErrorCode.SPRINT_NOT_FOUND, ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(
                        RuntimeException ex,
            HttpServletRequest request) {
                return build(HttpStatus.INTERNAL_SERVER_ERROR, ErrorCode.SPRINT_UNEXPECTED, "Internal server error", request);
    }
