...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(
        ...
        return build(HttpStatus.NOT_FOUND, ErrorCode.PROJECT_NOT_FOUND, ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(
                        RuntimeException ex,
            HttpServletRequest request) {
                return build(HttpStatus.INTERNAL_SERVER_ERROR, ErrorCode.PROJECT_UNEXPECTED, "Internal server error", request);
    }
