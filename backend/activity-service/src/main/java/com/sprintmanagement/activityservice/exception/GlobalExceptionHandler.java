...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleEntityNotFound(
        ...
        return build(HttpStatus.NOT_FOUND, ErrorCode.ACTIVITY_NOT_FOUND, ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(
                ...
                return build(HttpStatus.INTERNAL_SERVER_ERROR, ErrorCode.ACTIVITY_UNEXPECTED, "Internal server error", request);
    }
